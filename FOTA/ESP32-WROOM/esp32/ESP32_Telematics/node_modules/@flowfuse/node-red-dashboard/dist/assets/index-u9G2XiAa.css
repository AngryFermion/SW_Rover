.pwa-toast[data-v-da2fdc7e]{position:fixed;right:0;bottom:0;margin:16px;padding:12px;border:1px solid #8885;background-color:rgb(var(--v-theme-background));border-radius:4px;z-index:1;text-align:left;box-shadow:3px 4px 5px #8885;display:grid}.pwa-toast .message[data-v-da2fdc7e]{margin-bottom:8px}.pwa-toast .buttons[data-v-da2fdc7e]{display:flex}.pwa-toast button[data-v-da2fdc7e]{border:1px solid #8885;outline:none;margin-right:5px;border-radius:2px;padding:3px 10px}.pwa-toast button.reload[data-v-da2fdc7e]{display:block}.nrdb-debug-view{margin:12px;max-width:1200px}.nrdb-debug-view h1{display:flex;flex-direction:row;align-items:center;justify-content:space-between}.nrdb-debug-description{font-size:.85rem;padding:16px}.debug-filters{display:flex;flex-direction:row;align-items:center;justify-content:flex-start;margin:16px}.debug-filters label{margin-right:1rem}.debug-filters-chips{display:flex;gap:8px;align-items:center}.nested-table,.nested-table .v-table{background-color:#eee}button.v-btn[data-v-1926b240]{min-height:unset!important;height:2.4em;min-width:6em}.nrdb-ui-notification{padding-top:64px}.nrdb-ui-notification .v-snackbar__wrapper{background-color:rgb(var(--v-theme-group-background));color:rgb(var(--v-theme-on-group-background));border-left:6px solid var(--nrdb-ui-notification-color);min-width:auto}.nrdb-ui-notification .v-snackbar__content{padding:8px 12px}.nrdb-ui-notification-countdown{position:absolute;width:calc(100% + 6px);top:0;left:0;margin-left:-6px;border-top-left-radius:4px}.nrdb-ui-notification h1,.nrdb-ui-notification h2,.nrdb-ui-notification h3,.nrdb-ui-notification h4{margin:.5rem 0}.item-edit-mode-icon[data-v-d3fd5627]{color:rgb(var(--v-theme-warning))!important;font-size:1.25rem}.nrdb-resizable[data-v-c47bd4bf]{position:absolute;width:100%;height:100%;top:0;left:0;--handle-size: 8px;--handle-opacity: .25;--handle-accent: transparent;transition-property:box-shadow,transform,opacity,border;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1);border-color:0px dashed transparent;border:1px dashed #bcbcbc;cursor:grab}.nrdb-resizable.resizing[data-v-c47bd4bf]{z-index:1000!important;background-color:#ff00001f;border:1px dashed red}.nrdb-resizable[data-v-c47bd4bf]:hover,.nrdb-resizable[data-v-c47bd4bf]:active{border:1px dashed red;--handle-opacity: 1;--handle-accent: red}.nrdb-resizable--handle[data-v-c47bd4bf]{position:absolute;background-color:#fff;border:1px solid black;border-radius:3px;transition-property:box-shadow,transform,opacity,border-color,background-color;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}.nrdb-resizable--handle[data-v-c47bd4bf]:hover,.nrdb-resizable--handle[data-v-c47bd4bf]:active{--handle-opacity: 1;--handle-accent: red;background-color:#eee;border-color:var(--handle-accent)}.nrdb-resizable--right[data-v-c47bd4bf]{height:calc(3 * var(--handle-size));width:var(--handle-size);top:50%;margin-top:calc(-1.5 * var(--handle-size));right:calc(-1 * var(--handle-size) / 2);display:flex;justify-content:center;align-items:center;cursor:ew-resize!important}.nrdb-resizable--bottom[data-v-c47bd4bf]{height:var(--handle-size);width:calc(3 * var(--handle-size));left:50%;margin-left:calc(-1.5 * var(--handle-size));bottom:calc(-1 * var(--handle-size) / 2);display:flex;justify-content:center;align-items:center;cursor:ns-resize!important}.nrdb-resizable--right[data-v-c47bd4bf]:after{content:"";height:calc(.75 * var(--handle-size));width:1px;display:inline-block;background-color:var(--handle-accent)}.nrdb-resizable--bottom[data-v-c47bd4bf]:after{content:"";height:1px;width:calc(.75 * var(--handle-size));display:inline-block;background-color:var(--handle-accent)}.nrdb-resizable[data-v-c47bd4bf]{--toolbar-opacity: 0}.nrdb-resizable[data-v-c47bd4bf]:hover{--toolbar-opacity: 1}.nrdb-resizable .nrdb-resizable--toolbar[data-v-c47bd4bf]{position:absolute;top:8px;right:12px;z-index:101;opacity:var(--toolbar-opacity, 0)}.nrdb-resizable .nrdb-resizable--toolbar[data-v-c47bd4bf]:hover{--toolbar-opacity: 1}.nrdb-resizable .nrdb-resizable--toolbar>.nrdb-resizable--toolbar-button[data-v-c47bd4bf]{width:20px;height:20px;min-height:20px;min-width:20px;cursor:pointer}.nrdb-resizable .nrdb-resizable--toolbar>.nrdb-resizable--toolbar-button[data-v-c47bd4bf]:hover{--toolbar-opacity: 1}.nrdb-ui-editor-tray-container[data-v-9e9a4d71]{position:fixed;top:0;z-index:1000;display:flex;justify-content:center;flex-direction:column;align-items:center;--shadow: 0px 0px 5px #000000de;width:fit-content;left:50%;right:50%;transform:translate(-50%)}.nrdb-ui-editor-tray[data-v-9e9a4d71]{background-color:#fff;border:1px solid #ccc;padding:6px 12px;border-bottom-left-radius:12px;border-bottom-right-radius:12px;display:flex;gap:12px;box-shadow:var(--shadow);z-index:2}.nrdb-ui-editor-tray .v-btn[data-v-9e9a4d71]{border-radius:2.6rem;width:2.6rem;height:2.6rem;min-width:2.6rem;min-height:2.6rem}.nrdb-ui-editor-tray button[data-v-9e9a4d71]:disabled{filter:grayscale(1)}.nrdb-edit-mode--message[data-v-9e9a4d71]{padding:3px 9px;font-size:.875rem;border-bottom-left-radius:6px;border-bottom-right-radius:6px;background-color:rgb(var(--v-theme-navigation-background));color:rgba(var(--v-theme-on-navigation-background),var(--v-high-emphasis-opacity));box-shadow:var(--shadow)}[data-v-2800b3ba] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-2800b3ba]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--flex[data-v-2800b3ba]{--layout-card-width: 320px;--layout-gap: 12px;--layout-columns: 100}.nrdb-layout--flex[data-v-2800b3ba]{display:flex;flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--flex>div[data-v-2800b3ba]{max-width:100%}.v-card[data-v-2800b3ba]{width:100%}@media only screen and (max-width: 576px){.nrdb-layout--flex[data-v-2800b3ba]{--layout-columns: 3}}[data-v-deeffdde] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-deeffdde]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--grid[data-v-deeffdde]{--layout-card-width: 320px;--layout-gap: 12px}.nrdb-layout--grid[data-v-deeffdde]{--layout-columns: var(--0e2c4734);display:grid;grid-template-columns:repeat(var(--layout-columns),1fr);flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.v-card[data-v-deeffdde]{width:100%}[data-v-c88f8420] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-c88f8420]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--notebook[data-v-c88f8420]{--layout-card-width: 1024px;--layout-gap: 12px}.nrdb-layout--notebook[data-v-c88f8420]{margin:auto;width:100%;max-width:var(--layout-card-width);min-height:100%;flex-wrap:wrap;padding:var(--page-padding);--layout-columns: var(--0f9ee0ac)}.nrdb-layout--notebook>div[data-v-c88f8420]{width:100%;margin-bottom:var(--group-gap)}.v-card[data-v-c88f8420]{width:100%}[data-v-17aafaa8] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-17aafaa8]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--tabs[data-v-17aafaa8]{--layout-gap: 12px;--widget-row-height: 48px;--layout-columns: var(--80d2c322);padding:var(--page-padding)}.v-card[data-v-17aafaa8]{width:100%}.nrdb-edit-mode .nrdb-spacer{background-color:#007cff12;border:1px dashed #71aafc;border-radius:4px}.nrdb-edit-mode .nrdb-spacer:before{content:var(--0a328d4e);font-style:italic;display:grid;place-items:center;height:100%;color:#0049ff75;white-space:normal;text-align:center;font-size:.8em}.nrdb-ui-audio audio{width:100%;height:100%}.hidden{display:none!important}.nrdb-ui-button--icon .v-btn__append{margin-left:0;margin-inline:initial}.nrdb-ui-button--icon .v-btn__prepend{margin-right:0;margin-inline:initial}.nrdb-ui-button .v-btn .v-icon{--v-icon-size-multiplier: 1}.nrdb-ui-button .nrdb-ui-button--icon .v-icon{--v-icon-size-multiplier: 1.1}.nrdb-ui-button-group-wrapper{display:flex;flex-direction:row;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px}.nrdb-ui-button-group-wrapper .v-chip__content{white-space:normal}.nrdb-ui-button-group-wrapper .v-btn-group{width:max-content;border-width:thin;border-color:rgba(var(--v-border-color),var(--v-border-opacity));min-height:var(--widget-row-height);max-height:100%}.v-btn-group--density-comfortable.v-btn-group,.v-btn-group--density-default.v-btn-group,.v-btn-group--density-compact.v-btn-group{height:initial!important}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated{color:rgb(var(--v-theme-on-group-background));background-color:rgb(var(--v-theme-group-background))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated{--v-activated-opacity: 0}.nrdb-ui-button-group-wrapper .icon-only .v-btn__prepend{margin-inline:0}.nrdb-ui-button-group-wrapper .v-btn.v-btn--disabled .v-btn__overlay{opacity:.1}.nrdb-ui-button-group-wrapper .v-btn-group .v-btn--disabled .v-btn__content{color:rgb(var(--v-theme-on-group-background),var(--v-disabled-opacity))}.nrdb-ui-chart-container[data-v-2914bd13]{position:relative;width:100%}.nrdb-ui-chart[data-v-2914bd13]{width:100%;height:100%}.nrdb-ui-chart-placeholder[data-v-2914bd13]{position:absolute;display:flex;justify-content:center;align-items:center;top:0;width:100%;height:100%;color:rgba(var(--v-theme-on-group-background),var(--v-disabled-opacity));--pie-slice-1: rgba(var(--v-theme-on-group-background), .05);--pie-slice-2: rgba(var(--v-theme-on-group-background), .1);background:radial-gradient(circle closest-side,rgb(var(--v-theme-group-background)) 50%,transparent 0),radial-gradient(circle closest-side,transparent 66%,rgb(var(--v-theme-group-background)) 0),conic-gradient(var(--pie-slice-1) 0,var(--pie-slice-1) 38%,var(--pie-slice-2) 0,var(--pie-slice-2) 61%)}.nrdb-ui-file-input{display:flex;gap:12px}.nrdb-ui-file-input .v-btn{max-height:var(--widget-row-height)}.nrdb-ui-file-input--progress{width:100%;display:flex;align-items:center}.nrdb-ui-file-input--uploaded{flex-grow:1;display:flex;align-items:center;justify-content:flex-start;gap:6px;height:var(--widget-row-height)}.nrdb-ui-gauge-battery--container[data-v-9cecaa00]{display:flex;flex-direction:column}.nrdb-ui-gauge-battery[data-v-9cecaa00]{--battery-margin: 12px;--battery-radius: 12px;--battery-border: 8px;border-radius:var(--battery-radius);border-width:var(--battery-border);padding:6px;border-color:var(--gauge-fill);border-style:solid;flex-grow:1;position:relative}.nrdb-ui-gauge-battery--horizontal[data-v-9cecaa00]{margin-right:var(--battery-margin)}.nrdb-ui-gauge-battery--vertical[data-v-9cecaa00]{margin-top:var(--battery-margin)}.nrdb-ui-gauge-battery-icon[data-v-9cecaa00]{position:absolute;width:100%;height:100%;display:flex;justify-content:center;align-items:center;fill-opacity:.25}.nrdb-ui-gauge-battery-icon.nrdb-ui-gauge-battery-icon--bg[data-v-9cecaa00]{color:#000}.nrdb-ui-gauge-battery-icon.nrdb-ui-gauge-battery-icon--fill[data-v-9cecaa00]{color:#fff}.nrdb-ui-gauge-battery-labels[data-v-9cecaa00]{position:relative;width:100%;height:100%;display:flex;justify-content:center;align-items:center;container-type:size}.nrdb-ui-gauge-battery label[data-v-9cecaa00]{font-weight:700;resize:both;font-size:min(2.5rem,max(25cqmin,.5rem));position:relative;z-index:2;width:100%;height:100%;text-align:center;white-space:nowrap}.nrdb-ui-gauge-battery label.nrdb-ui-gauge-battery--fglabel[data-v-9cecaa00]{clip-path:url(#clip)}.nrdb-ui-gauge-battery label.nrdb-ui-gauge-battery--bglabel[data-v-9cecaa00]{color:rgb(var(--v-theme-on-group-background));position:absolute;left:0;top:0;z-index:1}.nrdb-ui-gauge-battery--center[data-v-9cecaa00]{display:flex;justify-content:center;align-items:center;height:100%;position:relative}.nrdb-ui-gauge-battery--fill[data-v-9cecaa00]{background-color:var(--gauge-fill)}.nrdb-ui-gauge-battery svg[data-v-9cecaa00]{top:0}.nrdb-ui-gauge-battery svg[data-v-9cecaa00],.nrdb-ui-gauge-battery--fill[data-v-9cecaa00]{position:absolute;left:0}.nrdb-ui-gauge-battery--horizontal svg[data-v-9cecaa00],.nrdb-ui-gauge-battery--horizontal .nrdb-ui-gauge-battery--fill[data-v-9cecaa00]{top:0;height:100%;width:var(--gauge-fill-pc)}.nrdb-ui-gauge-battery--vertical svg[data-v-9cecaa00],.nrdb-ui-gauge-battery--vertical .nrdb-ui-gauge-battery--fill[data-v-9cecaa00]{bottom:0;height:var(--gauge-fill-pc);width:100%}.nrdb-ui-gauge-battery[data-v-9cecaa00]:after{content:"";background-color:var(--gauge-fill);display:block;position:absolute}.nrdb-ui-gauge-battery--horizontal[data-v-9cecaa00]:after{width:var(--battery-margin);height:40%;top:30%;right:calc(-1 * var(--battery-margin) - var(--battery-border));border-top-right-radius:calc(var(--battery-radius) * .5);border-bottom-right-radius:calc(var(--battery-radius) * .5)}.nrdb-ui-gauge-battery--vertical[data-v-9cecaa00]:after{width:40%;height:var(--battery-margin);top:calc(-1 * var(--battery-margin) - var(--battery-border));right:30%;border-top-left-radius:calc(var(--battery-radius) * .5);border-top-right-radius:calc(var(--battery-radius) * .5)}.nrdb-ui-gauge-battery-icon svg[data-v-9cecaa00]{width:40%;height:40%;position:relative}.nrdb-ui-gauge-battery--horizontal .nrdb-ui-gauge-battery-icon svg[data-v-9cecaa00]{height:80%}.nrdb-ui-gauge svg{flex-grow:1;max-width:100%;position:relative}.nrdb-ui-gauge-title{display:block;text-align:center;font-weight:700;font-size:1rem;padding-bottom:4px}.nrdb-ui-gauge-value{position:absolute;width:100%;height:100%;display:flex;align-content:center;justify-content:center;flex-direction:column;text-align:center;flex-wrap:wrap;padding-top:12px;container-type:size}.nrdb-ui-gauge-value span{font-weight:700}.nrdb-ui-gauge-value label{display:flex;align-items:center;justify-content:center}.nrdb-ui-gauge #backdrop path{fill:rgb(var(--v-theme-background))}.nrdb-ui-gauge #sections path{stroke:rgb(var(--v-theme-group-background));stroke-width:2px}.nrdb-ui-gauge #limits{opacity:.5;fill:rgb(var(--v-theme-on-group-background));container-type:size}.nrdb-ui-gauge #limits text{font-size:min(1rem,max(2cqmin,.8rem))}.nrdb-ui-gauge #needle-container{pointer-events:none}.nrdb-ui-gauge #needle-mask{opacity:0}.nrdb-ui-gauge #needle circle,.nrdb-ui-gauge #needle polygon{fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-value label{font-size:.75rem;line-height:.825rem;gap:4px}.nrdb-ui-gauge-icon-only i{font-size:1.75em}.nrdb-ui-gauge-size-xxs .nrdb-ui-gauge-value,.nrdb-ui-gauge-size-xxs #limits{visibility:hidden}.nrdb-ui-gauge-size-xs .nrdb-ui-gauge-value span{font-size:min(1.5rem,max(2cqmin,.8rem));line-height:min(1.5rem,max(2cqmin,1rem))}.nrdb-ui-gauge-size-xs .nrdb-ui-gauge-value{font-size:min(.75rem,max(2cqmin,.5rem));line-height:min(.825rem,max(2cqmin,.65rem))}.nrdb-ui-gauge-size-sm .nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value span{font-size:2.5rem;line-height:3rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value label{font-size:1rem;line-height:1.25rem}.nrdb-ui-gauge-size-lg .nrdb-ui-gauge-value span{font-size:3rem;line-height:3.25rem}.Wave[data-v-fd5f6dc7],.WaveBG[data-v-fd5f6dc7]{width:200%;position:absolute;overflow:visible;animation-name:swell-fd5f6dc7;animation-fill-mode:forwards;animation-iteration-count:infinite;animation-timing-function:linear;fill:var(--gauge-fill);bottom:var(--gauge-fill-pc)}.WaveBG[data-v-fd5f6dc7]{opacity:.4;animation-duration:1.5s;animation-delay:1.2s}.Wave[data-v-fd5f6dc7]{animation-duration:2s}@keyframes swell-fd5f6dc7{0%{transform:scaleX(2) translate(25%) translateY(1px)}to{transform:scaleX(2) translate(-25%) translateY(1px)}}.nrdb-ui-gauge-tank--container[data-v-fd5f6dc7]{display:flex;flex-direction:column;container:tank-container / size}.nrdb-ui-gauge-tank[data-v-fd5f6dc7]{--tank-margin: 6px;--tank-padding: 3px;--tank-radius: 6px;--tank-border: 4px}@container tank-container (min-width: 75px) and (min-height: 75px){.nrdb-ui-gauge-tank[data-v-fd5f6dc7]{--tank-margin: 12px;--tank-radius: 12px;--tank-border: 8px;--tank-padding: 6px}}.nrdb-ui-gauge-tank[data-v-fd5f6dc7]{border-radius:var(--tank-radius);border-width:var(--tank-border);padding:var(--tank-padding);border-color:var(--gauge-fill);border-style:solid;flex-grow:1;position:relative}.nrdb-ui-gauge-tank--fill[data-v-fd5f6dc7]{background-color:transparent}.nrdb-ui-gauge-tank-labels[data-v-fd5f6dc7]{position:relative;width:100%;height:100%;display:flex;justify-content:center;align-items:center;container-type:size}.nrdb-ui-gauge-tank label[data-v-fd5f6dc7]{font-weight:700;resize:both;font-size:min(2.5rem,50cqmin);position:relative;z-index:2;width:100%;height:100%;text-align:center;white-space:nowrap;color:#000;--text-border: 1px;--text-border-inv: -1px ;--text-border-color: white;text-shadow:var(--text-border) var(--text-border-inv) var(--text-border-color),var(--text-border-inv) var(--text-border-inv) var(--text-border-color),var(--text-border-inv) var(--text-border) var(--text-border-color),var(--text-border) var(--text-border) var(--text-border-color)}.nrdb-ui-gauge-tank--center[data-v-fd5f6dc7]{display:flex;justify-content:center;align-items:center;height:100%;position:relative;overflow:hidden}.nrdb-ui-gauge-tank svg.mask[data-v-fd5f6dc7]{top:0}.nrdb-ui-gauge-tank svg.mask[data-v-fd5f6dc7],.nrdb-ui-gauge-tank--fill[data-v-fd5f6dc7]{position:absolute;left:0}.nrdb-ui-gauge-tank--fill[data-v-fd5f6dc7]{bottom:0;height:var(--gauge-fill-pc);width:100%}.nrdb-ui-gauge-tile[data-v-5aee6c0d]{display:flex;justify-content:center;align-items:center;container-type:size;font-weight:700;transition:.15s background-color;border:1px solid rgb(var(--v-theme-group-outline))}.nrdb-ui-gauge-tile label[data-v-5aee6c0d]{text-align:center;font-size:16px;font-size:min(16cqw,max(40cqmin,.5rem));line-height:normal}.nrdb-ui-gauge-tile-floating-label[data-v-5aee6c0d]{position:absolute;opacity:.6;font-size:min(5cqw,max(25cqmin,.4rem));line-height:min(5cqw,max(25cqmin,.4rem))}.nrdb-ui-gauge{position:relative}/*!
  Theme: Default
