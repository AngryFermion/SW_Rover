...
## 
## Makefile     : ACC.mk
## Generated on : Wed May 06 16:01:43 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ACC.exe
...
PRODUCT_NAME              = ACC
MAKEFILE                  = ACC.mk
MATLAB_ROOT               = D:\MATLAB\matlab
MATLAB_BIN                = D:\MATLAB\matlab\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = E:\ANCIT\SmartCarKit
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = ACC_comp.rsp
CMD_FILE                  = ACC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ACC.exe
...
DEFINES_STANDARD = -DMODEL=ACC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\ACC_grt_rtw\ACC.c $(START_DIR)\ACC_grt_rtw\ACC_data.c $(START_DIR)\ACC_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj ACC.obj ACC_data.obj rt_nonfinite.obj
...
{$(START_DIR)\ACC_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ACC_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ACC_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ACC_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ACC.obj : "$(START_DIR)\ACC_grt_rtw\ACC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ACC_grt_rtw\ACC.c"


ACC_data.obj : "$(START_DIR)\ACC_grt_rtw\ACC_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ACC_grt_rtw\ACC_data.c"


rt_nonfinite.obj : "$(START_DIR)\ACC_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ACC_grt_rtw\rt_nonfinite.c"
